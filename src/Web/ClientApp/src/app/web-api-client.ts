...
export class VehiclesClient implements IVehiclesClient {
    ...
    protected processGetVehicles(response: HttpResponseBase): Observable<PagedResultOfVehicleDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processGetVehicleById(response: HttpResponseBase): Observable<VehicleDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IVehiclesTypesClient {
    ...
    getVehicleTypes(pageNumber: number | undefined, pageSize: number | undefined, searchBy: string | null | undefined, orderBy: string | null | undefined, sortOrder: number | undefined): Observable<PagedResultOfVehicleTypeDto>;
    updateVehicleType(id: string, command: UpdateVehicleTypeCommand): Observable<void>;
    deleteVehicleType(id: string): Observable<void>;
    getVehicleTypeById(id: string): Observable<VehicleTypeDto>;
}
...
export class VehiclesTypesClient implements IVehiclesTypesClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PagedResultOfVehicleTypeDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PagedResultOfVehicleTypeDto>;
        }));
    }

    protected processGetVehicleTypes(response: HttpResponseBase): Observable<PagedResultOfVehicleTypeDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagedResultOfVehicleTypeDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    protected processGetVehicleTypeById(response: HttpResponseBase): Observable<VehicleTypeDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = VehicleTypeDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export interface IDriverInspectionsClient {
    ...
    getDriverInspections(pageNumber: number | undefined, pageSize: number | undefined, searchBy: string | null | undefined, orderBy: string | null | undefined, sortOrder: number | undefined): Observable<PagedResultOfDriverInspectionDto>;
    ...
    getDriverInspectionById(id: string): Observable<DriverInspectionDto>;
}
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PagedResultOfDriverInspectionDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PagedResultOfDriverInspectionDto>;
        }));
    }

    protected processGetDriverInspections(response: HttpResponseBase): Observable<PagedResultOfDriverInspectionDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagedResultOfDriverInspectionDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<DriverInspectionDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<DriverInspectionDto>;
        }));
    }

    protected processGetDriverInspectionById(response: HttpResponseBase): Observable<DriverInspectionDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DriverInspectionDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export interface ICheckingsClient {
    ...
    getCheckingById(id: string): Observable<void>;
    updateCheckOut(id: string, command: UpdateCheckOutCommand): Observable<void>;
}

@Injectable({
    providedIn: 'root'
})
export class CheckingsClient implements ICheckingsClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    createCheckIn(command: CreateCheckInCommand): Observable<void> {
        let url_ = this.baseUrl + "/api/Checkings";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateCheckIn(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getCheckingsByStatus(pageNumber: number | undefined, pageSize: number | undefined, searchBy: string | null | undefined, orderBy: string | null | undefined, sortOrder: number | undefined): Observable<void> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCheckingsByStatus(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCheckingsByStatus(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processGetCheckingsByStatus(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getCheckingById(id: string): Observable<void> {
        let url_ = this.baseUrl + "/api/Checkings/{Id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{Id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCheckingById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCheckingById(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processGetCheckingById(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    updateCheckOut(id: string, command: UpdateCheckOutCommand): Observable<void> {
        ...
        return this.http.request("patch", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateCheckOut(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateCheckOut(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processUpdateCheckOut(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class VehicleDto implements IVehicleDto {
    ...
    model?: string | undefined;
    plateNumber?: string | undefined;
    insuranceFrom?: string | undefined;
    insuranceTo?: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.model = _data["model"];
            this.plateNumber = _data["plateNumber"];
            this.insuranceFrom = _data["insuranceFrom"];
            this.insuranceTo = _data["insuranceTo"];
    ...
    toJSON(data?: any) {
        ...
        data["model"] = this.model;
        data["plateNumber"] = this.plateNumber;
        data["insuranceFrom"] = this.insuranceFrom;
        data["insuranceTo"] = this.insuranceTo;
...
export class PagedResultOfVehicleDto implements IPagedResultOfVehicleDto {
    ...
    constructor(data?: IPagedResultOfVehicleDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
...
export interface IPagedResultOfVehicleDto {
    data?: VehicleDto[] | undefined;
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class PagedResultOfVehicleTypeDto implements IPagedResultOfVehicleTypeDto {
    data?: VehicleTypeDto[] | undefined;
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    hasPreviousPage?: boolean;
    ...
    constructor(data?: IPagedResultOfVehicleTypeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["data"])) {
                this.data = [] as any;
                for (let item of _data["data"])
                    this.data!.push(VehicleTypeDto.fromJS(item));
            }
            this.pageNumber = _data["pageNumber"];
            this.totalPages = _data["totalPages"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PagedResultOfVehicleTypeDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultOfVehicleTypeDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultOfVehicleTypeDto {
    data?: VehicleTypeDto[] | undefined;
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class DriverInspectionDto implements IDriverInspectionDto {
    id?: string | undefined;
    driverId?: string | undefined;
    ...
    constructor(data?: IDriverInspectionDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): DriverInspectionDto {
        data = typeof data === 'object' ? data : {};
        let result = new DriverInspectionDto();
        result.init(data);
        return result;
    }
...
export interface IDriverInspectionDto {
    id?: string | undefined;
    driverId?: string | undefined;
    driverName?: string | undefined;
    reviewedBy?: string | undefined;
...
export class PagedResultOfDriverInspectionDto implements IPagedResultOfDriverInspectionDto {
    data?: DriverInspectionDto[] | undefined;
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    hasPreviousPage?: boolean;
    ...
    constructor(data?: IPagedResultOfDriverInspectionDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["data"])) {
                this.data = [] as any;
                for (let item of _data["data"])
                    this.data!.push(DriverInspectionDto.fromJS(item));
            }
            this.pageNumber = _data["pageNumber"];
            this.totalPages = _data["totalPages"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PagedResultOfDriverInspectionDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultOfDriverInspectionDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultOfDriverInspectionDto {
    data?: DriverInspectionDto[] | undefined;
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class CreateCheckInCommand implements ICreateCheckInCommand {
    ...
    constructor(data?: ICreateCheckInCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.driverId = _data["driverId"];
            this.vehicleId = _data["vehicleId"];
            this.tankId = _data["tankId"];
            this.blNumber = _data["blNumber"];
        }
    }

    static fromJS(data: any): CreateCheckInCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateCheckInCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateCheckInCommand {
    siteId?: string | undefined;
    customerId?: string | undefined;
    driverId?: string | undefined;
    vehicleId?: string | undefined;
...
export class UpdateCheckOutCommand implements IUpdateCheckOutCommand {
    id?: string | undefined;
    blNumber?: string | undefined;
    invoiceNumber?: string | undefined;

    constructor(data?: IUpdateCheckOutCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateCheckOutCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateCheckOutCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateCheckOutCommand {
    id?: string | undefined;
    blNumber?: string | undefined;
    invoiceNumber?: string | undefined;
}
